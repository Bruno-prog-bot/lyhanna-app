// Amorce Flutter web PERSONNALISÉE (PM-4c, docs/30) — remplace le fichier
// généré par défaut. Les deux jetons ci-dessous sont remplacés au build.
//
// Pourquoi ce fichier existe : le moteur CanvasKit télécharge ses polices de
// REPLI (Noto : symboles, arabe, chinois, emoji…) depuis fonts.gstatic.com à
// l'exécution, pour chaque glyphe absent des polices embarquées. Sur le portail
// institutionnel c'est (1) une fuite vers Google à chaque visite, contraire à
// la doctrine « hébergement UE, aucun CDN Google », et (2) bloqué par la CSP.
// `fontFallbackBaseUrl` rebranche ces téléchargements sur NOTRE origine
// (`polices/`, miroir posé à la publication — ops/portail/miroir_polices.py).
// Sans miroir : un glyphe exotique s'affiche en carré, mais rien ne part
// jamais vers Google (fail-closed). La police de texte (Roboto) est, elle,
// embarquée dans l'application (pubspec.yaml).
...
_flutter.loader.load({
  ...
  serviceWorkerSettings: {
    serviceWorkerVersion: "3942467496" /* Flutter's service worker is deprecated and will be removed in a future Flutter release. */,
  },
});
